            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    @php
                        ...
                        if(Auth::check()) {
                            if(Auth::user()->role->nama_role == 'admin') $dashboardRoute = 'dashboard.admin';
                            elseif(Auth::user()->role->nama_role == 'petugas') $dashboardRoute = 'dashboard.petugas';
                            elseif(Auth::user()->role->nama_role == 'peminjam') $dashboardRoute = 'dashboard.peminjam';
                        }
                    @endphp
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @if(Auth::user()->role->nama_role == 'admin')
                        ...
                        <x-nav-link :href="route('alats.index')" :active="request()->routeIs('alats.*')">
                            {{ __('Alat') }}
                        </x-nav-link>
                    ...
                    @elseif(Auth::user()->role->nama_role == 'petugas')
                        ...
                        <x-nav-link :href="route('petugas.permintaan')" :active="request()->routeIs('petugas.permintaan')">
                            {{ __('Permintaan') }}
                        </x-nav-link>
                    ...
                    @elseif(Auth::user()->role->nama_role == 'peminjam')
                        ...
                        <x-nav-link :href="route('peminjam.alat')" :active="request()->routeIs('peminjam.alat') || request()->routeIs('peminjam.pinjam')">
                            {{ __('Daftar Alat') }}
                        </x-nav-link>
                    @endif
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @if(Auth::user()->role->nama_role == 'admin')
                ...
                <x-responsive-nav-link :href="route('alats.index')" :active="request()->routeIs('alats.*')">
                    {{ __('Alat') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('kategoris.index')" :active="request()->routeIs('kategoris.*')">
                    {{ __('Kategori') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('log-aktivitas.index')" :active="request()->routeIs('log-aktivitas.index')">
                    {{ __('Log Aktivitas') }}
                </x-responsive-nav-link>
            @elseif(Auth::user()->role->nama_role == 'petugas')
                <x-responsive-nav-link :href="route('dashboard.petugas')" :active="request()->routeIs('dashboard.petugas')">
                    {{ __('Dashboard') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('petugas.permintaan')" :active="request()->routeIs('petugas.permintaan')">
                    {{ __('Permintaan') }}
                </x-responsive-nav-link>
            ...
            @elseif(Auth::user()->role->nama_role == 'peminjam')
                ...
                <x-responsive-nav-link :href="route('peminjam.alat')" :active="request()->routeIs('peminjam.alat') || request()->routeIs('peminjam.pinjam')">
                    {{ __('Daftar Alat') }}
                </x-responsive-nav-link>
            @endif
        </div>
