    ...
    <div class="min-h-screen h-screen flex w-full bg-gradient-to-br from-blue-50 via-white to-blue-100 overflow-hidden">
        ...
        <div class="hidden lg:flex lg:w-1/2 relative h-full overflow-hidden">
            ...
            <div class="relative z-10 flex flex-col justify-center items-center w-full h-full px-12 text-center">
                ...
                <!-- LOGO SIPUT - DIPERBESAR SAMA LOGIN -->
            ...
            <div class="w-full max-w-md relative z-10 my-auto">
                ...
                <div class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/50 p-8">
                    ...
                    <div class="mb-6 text-center">
                        ...
                        <p class="text-gray-500 text-sm">Daftar untuk mulai meminjam alat.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('register') }}" class="space-y-4">
                        ...
                        <!-- Nama Lengkap -->
                        <div class="space-y-1">
                            <x-input-label for="nama_lengkap" :value="__('Nama Lengkap')" class="text-gray-700 font-semibold text-xs uppercase tracking-wider" />
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <!-- Kelas -->
                            <div class="space-y-1">
                                <x-input-label for="kelas" :value="__('Kelas')" class="text-gray-700 font-semibold text-xs uppercase tracking-wider" />
                                <div class="relative group">
                                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                        <svg class="h-4 w-4 text-gray-400 group-focus-within:text-blue-500 transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <x-input-error :messages="$errors->get('kelas')" class="mt-1 text-xs" />
                            </div>
                        </div>
                        ...
                        <div class="space-y-1">
                            ...
                            <div class="relative group">
                                ...
                                <!-- Toggle Password -->
                                <button type="button" onclick="togglePassword('password', 'eye-icon-password')" class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-blue-500 focus:outline-none transition-colors duration-200">
                                    <svg id="eye-icon-password" class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- Confirm Password -->
                        <div class="space-y-1">
                            <x-input-label for="password_confirmation" :value="__('Konfirmasi Password')" class="text-gray-700 font-semibold text-xs uppercase tracking-wider" />
                            <div class="relative group">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <svg class="h-4 w-4 text-gray-400 group-focus-within:text-blue-500 transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <button type="button" onclick="togglePassword('password_confirmation', 'eye-icon-confirm')" class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-blue-500 focus:outline-none transition-colors duration-200">
                        ...
                        <!-- Login Button -->
                        <a href="{{ route('login') }}" class="group w-full inline-flex justify-center items-center gap-2 py-3 px-4 border-2 border-blue-200 rounded-xl text-sm font-bold text-blue-600 bg-blue-50/50 hover:bg-blue-100 hover:border-blue-300 hover:text-blue-700 transition-all duration-200">
