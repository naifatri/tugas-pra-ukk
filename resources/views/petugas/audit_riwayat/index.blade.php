        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-lg sm:rounded-xl">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="GET" action="{{ route('petugas.audit-riwayat.index') }}" class="space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="flex items-end gap-3">
                                ...
                                <a href="{{ route('petugas.audit-riwayat.index') }}" class="flex-1 inline-flex justify-center items-center px-4 py-2 bg-gray-300 hover:bg-gray-400 dark:bg-gray-600 dark:hover:bg-gray-700 text-gray-800 dark:text-white text-sm font-medium rounded-lg shadow-md hover:shadow-lg transition-all duration-300">
                                    Reset
                                </a>
                            </div>
                        </div>
                                ...
                                <thead>
                                    <tr class="bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600">
                                        ...
                                        <th class="px-6 py-4 text-center font-semibold text-gray-900 dark:text-gray-100">
                                            <a href="{{ route('petugas.audit-riwayat.index', array_merge(request()->query(), ['sort' => 'stok', 'order' => request('order') === 'asc' && request('sort') === 'stok' ? 'desc' : 'asc'])) }}" class="hover:underline flex items-center justify-center gap-1">
                                                Stok
                                        ...
                                        <th class="px-6 py-4 text-center font-semibold text-gray-900 dark:text-gray-100">
                                            <a href="{{ route('petugas.audit-riwayat.index', array_merge(request()->query(), ['sort' => 'kondisi', 'order' => request('order') === 'asc' && request('sort') === 'kondisi' ? 'desc' : 'asc'])) }}" class="hover:underline flex items-center justify-center gap-1">
                                                Kondisi
                                        ...
                                        <th class="px-6 py-4 text-center font-semibold text-gray-900 dark:text-gray-100">
                                            <a href="{{ route('petugas.audit-riwayat.index', array_merge(request()->query(), ['sort' => 'total_pinjam', 'order' => request('order') === 'asc' && request('sort') === 'total_pinjam' ? 'desc' : 'asc'])) }}" class="hover:underline flex items-center justify-center gap-1">
                                                Total Dipinjam
                                ...
                                <tbody>
                                    @foreach($alats as $key => $alat)
                                        <tr class="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                            ...
                                            <td class="px-6 py-4 text-center">
                                                <a href="{{ route('petugas.audit-riwayat.show', $alat->id) }}" class="inline-flex items-center px-3 py-2 bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 hover:bg-indigo-200 dark:hover:bg-indigo-900/50 rounded-lg font-medium transition-colors text-xs">
